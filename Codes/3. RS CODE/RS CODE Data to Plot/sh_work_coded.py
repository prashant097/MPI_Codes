# RS Coded distributed matrix-vector multiplication
...
for iter in range(0, niter):
    ...
    if rank == 0:
        ...
        total_err = total_err + numpy.linalg.norm(y - A.dot(x))  # Frobenius norm of the difference
